...
def get_args():
    ...
    # mocap specific
    parser.add_argument("--mocap_traj_limitation", type=int, default=256)    
    parser.add_argument("--mocap_expert_path", type=str, default="../merel-mocap-gail-modified/data/cmu_mocap.npz.pkl")
